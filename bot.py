...
class PolariseBot:
    def __init__(self, proxy=None, captcha_api_key=None):
        ...
        self.random_titles = [
            "Hello everyone!", "Good morning guys", "Hey there!", "Greetings folks",
            "What's up everyone", "Hello world", "Hi there friends", "Good day all",
            "Hey guys!", "Welcome everyone"
        ]
        
        self.random_comments = [
            "lfg", "gm", "nice!", "amazing", "great work", "awesome!", "love it",
            "interesting", "cool stuff", "well done", "fantastic", "impressive"
        ]
    ...
    def login(self, wallet_address, private_key, nonce, sub_id, inviter_code=""):
        ...
        try:
            ...
            if hasattr(signed.signature, 'hex'):
                ...
                signature = signed.signature.to_hex() if hasattr(signed.signature, 'to_hex') else signed.signature.hex()
    ...
    def follow_user(self, wallet_address, target_user_id, target_user_name):
        ...
        payload = {
            ...
            "actor_user_name": wallet_address[:6],
    ...
    while True:
        ...
        for i, private_key in enumerate(private_keys):
            ...
            try:
                ...
                bot.log(f"Process failed: {str(e)}", "ERROR")
                fail_count += 1
